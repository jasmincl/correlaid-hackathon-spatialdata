...
Thanks to the [Deutsche Bahn Open Data Portal](https://data.deutschebahn.com/), we can access a data set of bikesharing trip start and end from 2014-2017 in several German cities. 
